...
def build_report(protein1_name, protein2_name,
    ...
    for n in range(len(list_of_HomologousPeptidePairs)):
        ...
        if PDB1 is not None:
            ...
            pdb_seq1 = make_structure_map(pair.seq1, pair.peptide1.position, pair.peptide1.protein.proteinseq, PDB1, filename)
        ...
        if PDB2 is not None:
            ...
            pdb_seq2 = make_structure_map(pair.seq2, pair.peptide2.position, pair.peptide2.protein.proteinseq, PDB2, filename)
